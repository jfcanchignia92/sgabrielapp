...
@section('content')
    <div class="container">
        ...
        <h4 class="col-md-12">Nuevo Registro Bautismal</h4><br>
        @if($errors->any())
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3 form-group">
                                    ...
                                    <input name="PADRE" type="text" class="form-control" required value="{{old('PADRE')}}"/>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="Madre">Nombre de la Madre: </label>
                                    <input name="MADRE" type="text" class="form-control"  required value="{{old('MADRE')}}"/>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="padrino">Nombre del Padrino: </label>
                                    <input name="PADRINO" type="text" class="form-control" value="{{old('PADRINO')}}"/>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="Madrina">Nombre de la Madrina: </label>
                                    <input name="MADRINA" type="text" class="form-control" value="{{old('FECHA_NACIMIENTO')}}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-2 form-group">
                                    ...
                                    <input name="RGT_TOMO" type="number" min="1" class="form-control" required value="{{old('RGT_TOMO')}}"/>
                                </div>
                                <div class="col-md-2 form-group">
                                    <label for="pagina">Pagina #: </label>
                                    <input name="RGT_PAGINA" type="number" min="1" class="form-control" required value="{{old('RGT_PAGINA')}}"/>
                                </div>
                                <div class="col-md-2 form-group">
                                    <label for="registro">Registro #: </label>
                                    <input name="RGT_NUMERO" type="number"  class="form-control" value="{{$count}}" readonly />
                                </div>
                                <div class="col-md-3 form-group">
                                    <div><label for="FechaBautismo">Fecha de Bautismo: </label></div>
                                    <input name="RGT_FECHA" type="date" name="bday" class="form-control" required value="{{old('RGT_FECHA')}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="CuraBautismo">Sacerdote responsable del bautizo: </label>
                                    <input name="PARROCO" type="text" class="form-control" required value="{{old('PARROCO')}}"/>
                                </div>
                            </div>
                        </div>
                    </div>
