    ...
    <div class="container">
        <div class="row">
            <ol class="breadcrumb col-md-8">
                ...
                <li><a href="{{url('adminpage/Boletin')}}">Bolet&iacute;n Informativo</a></li>
                <li class="active">Modificar Bolet&iacute;n</li>
            </ol>
        </div>
        <h4 class="col-md-12">Modificar Bolet&iacute;n </h4><br><br>
        @if($errors->any())
            <br><div>
        ...
        <div>
                <div role="tabpanel" class="tab-pane" id="detalles">
                    <form role="form" method="POST" action="{{ url('adminpage/Boletin/'.$boletin->NT_ID) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="titulo" name="NT_TITULO" required value="{{$boletin->NT_TITULO}}"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline">
                                            @if($boletin->NT_VISIBLE == 'SI')
                                                <label><input type="radio" name="NT_VISIBLE" value="SI" checked >Si</label>
                                            @else
                                                <label><input type="radio" name="NT_VISIBLE" value="SI">Si</label>
                                            @endif
                                        </div>
                                        <div class="radio-inline">
                                            @if($boletin->NT_VISIBLE == 'NO')
                                                <label><input type="radio" name="NT_VISIBLE" value="NO" checked >No</label>
                                            @else
                                                <label><input type="radio" name="NT_VISIBLE" value="NO">No</label>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label> Contenido de la noticia: (Requerido) </label>
                                    <div>
                                        <textarea class="summernote" id="informacion" name="NT_CONTENIDO" required value="{!!$boletin->NT_CONTENIDO!!}"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
